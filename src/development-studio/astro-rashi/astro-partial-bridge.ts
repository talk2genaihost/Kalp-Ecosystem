...
window.fetch = async (input: RequestInfo | URL, init?: RequestInit): Promise<Response> => {
  ...
  if (!body || typeof body !== "object" || (body as Obj).status !== "PARTIAL_SUCCESS") return response;
  lastPartial = true;

...
async function main() {
  ...
  const prompt = [
    ...
    "Return JSON only with exactly these keys: summary, generalAnalysis, chartSynthesis, personality, planetaryAnalysis, houseAnalysis, career, relationships, finance, dasha, dashaTimeline, nakshatra, yogas, yogaAnalysis, strengths, cautions, focus, guidance. summary is a string; every other key is string[]. generalAnalysis must be 4–6 concrete synthesis bullets and is the primary high-level interpretation section.",
